...
function buildPrompt({ workspaceName, staleByStage, topCloseReasons, stagesWithoutAutomation }) {
  const lines = [];
...
[
  { "title": "כותרת קצרה", "description": "הסבר של משפט-שניים", "actionStageKey": null },
  ...
]
אם התובנה מציעה להוסיף תזכורת פולו-אפ אוטומטית לשלב ספציפי מתוך הרשימה "שלבים עם תנועה גבוהה" למעלה - מלא את actionStageKey במפתח הטכני המדויק של אותו שלב (למשל "call"). אחרת השאר null. אל תמציא מפתחות שלא הופיעו ברשימה.`;
}
