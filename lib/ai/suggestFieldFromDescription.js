...
הצעה סופית לשדה מחושב: {"needsClarification": false, "fieldKey": "donation_percent_paid", "label": "אחוז ששולם", "type": "computed", "expression": "percent(donation_paid, donation_total)", "unit": "%", "explanation": "אחוז מהתרומה שכבר שולם"}
