-- מבטל את 0125 (שהוציאה לגמרי מי שלא התקשרנו אליו) - המשתמש רוצה כן
-- לראות את כולם, אבל בשתי רשימות נפרדות: מי שבאמת פנינו אליו (יש
-- ניסיון-שיחה, attributed_agent_id לא null) לעומת מי שתרם בלי שפנינו
-- אליו בכלל (attributed_agent_id null) - החזרה ל-left join כמו ב-0124,
-- ה-UI (callDashboardActions.js) הוא זה שמפריד לשתי רשימות ברורות.
