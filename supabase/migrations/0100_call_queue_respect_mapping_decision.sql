-- באג: claim_next_campaign_contact/count_callable_campaign_contacts_by_category
-- הדירו אנשי-קשר לפי category בלבד - החלטת-מיפוי "לא רלוונטי"
-- (campaign_contacts.mapping_decision, שממולאת ע"י תהליך המיפוי הנפרד -
-- ר' MappingQueue.js/הגיליון) לא הייתה משפיעה בכלל על התור. עכשיו
-- מי שסומן "לא רלוונטי" במיפוי לא ייכנס לתור, גם אם הקטגוריה שלו
-- לא הוחרגה. גוף שאר הפונקציה זהה ל-0099 - רק שורת-תנאי אחת נוספה.
