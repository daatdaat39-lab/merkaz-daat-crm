  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '28px 24px' }}>
      ...
      <p style={{ margin: '0 0 20px', fontSize: 12.5, color: 'var(--text-secondary)' }}>
        עריכת שלבי התהליך לכל מחלקה - הוספה, מחיקה, שינוי תווית/צבע, קביעת שלב-ניצחון. המפתח הטכני קבוע לאחר יצירה.
      </p>
      <PipelinesClient workspaces={workspaces || []} stagesByWorkspaceId={stagesByWorkspaceId} />
    </div>
  );
}
